            ...
            <div class="container">
                <div class="col-md-12">
                    <div class="text-center">
                        ...
                        <h3 style="color: #84B0CA;">Create  A Purches</h3>
                ...
                <!-- <div class="row">
                    ...
                    <div class="col-xl-4">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span class="fw-bold">Supplier: </span></li>
                            <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span class="fw-bold">Creation Date: </span></li>
                    ...
                    <div style="width: 100%;" class="d-flex justify-content-between mb-3">
                        <div>
                            ...
                            <div class="input-icons">
                                ...
                                <input id="psearch" class="form-control input-field" placeholder="Search product" type="search" required="">
                ...
                <div style="margin-bottom: 100px;" class="d-flex justify-content-between">
                    <a id="purchesBtn" href="#" class="btn btn-bold px-4 float-right mt-3 mt-lg-0" style="background-color:#84B0CA;">Proceed Purches</a>
                </div>
                <div class="row">
                    <div class="col-xl-10">
