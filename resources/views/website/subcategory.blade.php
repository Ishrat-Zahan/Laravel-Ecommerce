        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
            <a href="">
                <div style="height: 80px;" class="card">
                    <div class="card-body">
                        <h5 style="margin-top: 30px;" class="card-title text-center mt-5">{{$row->name}}</h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </a>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-12 col-sm-6 single-product">
                        ...
                        <div class="content">
                            ...
                            <img class="content-image img-fluid d-block mx-auto" src="{{ asset('storage/' . $row->icon) }}" alt="">
                            <div class="content-details fadeIn-bottom">
                                <div class="bottom d-flex align-items-center justify-content-center">
                                    <a href="#"><span class="lnr lnr-heart"></span></a>
                                    <a href="#"><span class="lnr lnr-layers"></span></a>
                                    <a href="javascript:void(0)"><span data-product-id="{{$row->id}}" class="lnr lnr-cart"></span></a>
                                    <a href="details/{{$row->id}}" class="lnr lnr-frame-expand" data-toggle="modal" data-target="#exampleModal"><span></span></a>
